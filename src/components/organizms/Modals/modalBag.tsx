                    ...
                    {dataBag?.length == 0
                        ...
                        dataBag?.map((value: IBagPokemons, idx: number) => (
                            <div key={idx} className='bg-background px-5 py-3 rounded-lg border border-divider/60 flex items-center gap-3 my-3'>
                                ...
                                <div className='flex flex-1 flex-col text-start gap-1 justify-start items-start'>
                                    <div className='w-full leading-none text-start font-bold text-font-tertiary'>{value.name}</div>
                                    <div className='w-full leading-none text-start text-font-secondary text-sm'>{value.pokemon}</div>
                                </div>
